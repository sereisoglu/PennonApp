...
public extension AVPlayerViewController {
    ...
    func open(fileFromLocal filePath: URL, encoding: String.Encoding = String.Encoding.windowsCP1254) {
    ...
    func show(subtitles string: String) {
        ...
        // Parse
        parsedPayload = ControlSubtitle.parseSubRip(string)
    ...
    func addPeriodicNotification(parsedPayload: NSDictionary) {
        ...
        self.player?.addPeriodicTimeObserver(
            ...
            using: { [weak self] (time) -> Void in
                ...
                label.text = ControlSubtitle.searchSubtitles(strongSelf.parsedPayload, time.seconds)
