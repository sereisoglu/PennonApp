...
class SubtitleDetailView: UIView {
    ...
    private lazy var attributeLabel1: UILabel = {
        let label = UILabel()
        label.numberOfLines = 2
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "Size:\nEncoding:"
    ...
    private func setupDetailView() {
        ...
        NSLayoutConstraint.activate([
            ...
            attributeStackView.topAnchor.constraint(equalTo: label2.bottomAnchor, constant: 20),
...
extension SubtitleDetailView: Themed {
