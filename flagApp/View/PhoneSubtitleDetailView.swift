...
// TODO: neden ukit'in uzerinde cizgi var. Ve uikit'i ne zaman kullanmaliyiz?
import UIKit

class PhoneSubtitleDetailView: UIView {
    ...
    private func setupDetailView() {
        ...
        NSLayoutConstraint.activate([
            ...
            attributeStackView.topAnchor.constraint(equalTo: label2.bottomAnchor, constant: padding),
...
extension PhoneSubtitleDetailView: Themed {
