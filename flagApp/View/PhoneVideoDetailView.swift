...
class PhoneVideoDetailView: UIView {
    ...
    public lazy var buttonStackView: UIStackView = {
        let sv = UIStackView(arrangedSubviews: [button2, button3])
        sv.translatesAutoresizingMaskIntoConstraints = false
        sv.axis = .horizontal
        sv.spacing = 15
        sv.distribution = .fillEqually
    ...
    public lazy var buttonStackView2: UIStackView = {
        let sv = UIStackView(arrangedSubviews: [button4, button5])
        sv.translatesAutoresizingMaskIntoConstraints = false
        sv.axis = .horizontal
        sv.spacing = 15
        sv.distribution = .fillEqually
...
extension PhoneVideoDetailView: Themed {
    func applyTheme(_ theme: AppTheme) {
        ...
        button2Label.font = theme.paragraph1Font
