...
class TutorialController: UIViewController, UIGestureRecognizerDelegate {
    ...
    private func setupView() {
        ...
        NSLayoutConstraint.activate([
            backgroundView.topAnchor.constraint(equalTo: self.view.topAnchor, constant: 200),
            ...
            label1.topAnchor.constraint(equalTo: backgroundView.topAnchor, constant: 15),
    ...
    private func closeTutorialController() {
        self.dismiss(animated: true, completion: nil)
    }
    
}

extension TutorialController: Themed {
