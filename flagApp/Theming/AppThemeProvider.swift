...
final class AppThemeProvider: ThemeProvider {
	...
	private var availableThemes: [AppTheme] = [.lightPadPlus, .darkPadPlus, .lightPad, .darkPad, .lightPhone, .darkPhone]
	...
	init() {
		theme = SubscribableValue<AppTheme>(value: .lightPadPlus)
	}

	public func setNewTheme(_ newTheme: AppTheme) {
